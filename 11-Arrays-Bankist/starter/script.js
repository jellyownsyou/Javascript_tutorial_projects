...
// const moevementsDescriptions = movements.map((mov, i) =>
...
// console.log(moevementsDescriptions);
...
// FILTER RETURNS ALL ELEMENTS THAT MATCH CONDITION, THE FILTER RETURNS NEW ARRAY, FIND RETURNS FIRST VALUE THAT MEETS CONDITION AND NOT SAME ARRAY
...
// console.log(
//   `Sarah's dog is eating ${dogSarah.curFood > dogSarah.recFood} : 'much'`
// );
