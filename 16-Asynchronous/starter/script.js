...
//       resolve('You Win $$');
//     } else {
//       reject(new Error('You lost your money poop'));
//     }
//   }, 2000);
// });
...
// //   .catch(err => console.error(`2: ${err.message} explodeee`))
...
//     console.log(`2: ${city}`);
//   } catch (err) {
//     console.error(`2: ${err.message} explodeee`);
//   }
